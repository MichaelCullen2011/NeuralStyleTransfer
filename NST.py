...
if Train:
    ...
    #     the_file_root = 'Dog'
    # elif Teasdale1:
    #     content_path = tf.keras.utils.get_file('teasdale1.jpg', 'https://storage.googleapis.com/download.tensorflow.org/example_images/YellowLabradorLooking_new.jpg')
    #     the_file_root = 'Teasdale1'
    # elif Teasdale2:
    #     content_path = tf.keras.utils.get_file('Teasdale2.jpg', 'https://storage.googleapis.com/download.tensorflow.org/example_images/YellowLabradorLooking_new.jpg')
    #     the_file_root = 'Teasdale2'
    # elif Jasper:
...
if Save:
    file_name = '{}-{}.png'.format(image_to_use[0], style_to_use[0])
...
'''
if Display:
    Image.open(generated_dir + file_name)
    plt.show()
